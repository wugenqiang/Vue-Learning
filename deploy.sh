...
git add .
git status
git commit -m 'auto update https://wugenqiang.github.io/Vue-Learning'
echo '--------commit successfully--------'

# git push -f https://github.com/wugenqiang/CS-Notes.git master
git push -u https://github.com/wugenqiang/Vue-Learning.git master
...
git push -u https://gitee.com/wugenqiang/Vue-Learning.git master
